    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['policy', 'notice_type'], name='policies_po_policy__f7f50e_idx'), models.Index(fields=['is_important'], name='policies_po_is_impo_c15ec5_idx'), models.Index(fields=['order'], name='policies_po_order_e0cb63_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['policy', 'company'], name='policies_po_policy__7f6088_idx'), models.Index(fields=['company', 'expose_to_child'], name='policies_po_company_4964e8_idx'), models.Index(fields=['assigned_at'], name='policies_po_assigne_ed26da_idx')],
