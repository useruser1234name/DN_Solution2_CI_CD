...
import './CarrierPlanManagementPage.css';

const { Title, Text } = Typography;
const { Option } = Select;

const CarrierPlanManagementPage = () => {
  ...
  return (
    <div className="carrier-plan-management-page">
      <Card className="carrier-plan-card">
...
export default CarrierPlanManagementPage;