    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['inventory'], name='inventory_i_invento_b5a407_idx'), models.Index(fields=['transaction_type'], name='inventory_i_transac_2eccee_idx'), models.Index(fields=['user'], name='inventory_i_user_id_952fb3_idx'), models.Index(fields=['created_at'], name='inventory_i_created_670884_idx')],
            },
        ),
        migrations.AddIndex(
